"""
Django settings for backupdisasterrecov_45937 project.
...
ROOT_URLCONF = 'backupdisasterrecov_45937.urls'
...
WSGI_APPLICATION = 'backupdisasterrecov_45937.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "backupdisasterrecov_45937 API",
    "DESCRIPTION": "API documentation for backupdisasterrecov_45937 App",
    "VERSION": "v1",
}
